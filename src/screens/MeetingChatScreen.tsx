...
const CHAT_THEMES: Record<ThemeKey, ChatTheme> = {
  forest: { label: 'Forest', headerBg: '#0B2211', pageBg: '#0B2211', mineBg: '#1F5C39', otherBg: '#0F2A19', inputBg: '#0F2A19' },
...
const styles = StyleSheet.create({
  ...
  searchCancel: { color: '#4CAF50', fontSize: 12, fontWeight: '600' },
  tabBar: { flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: '#1C4A2E' },
  ...
  aiMsg: { borderColor: '#4CAF50', borderWidth: 1 },
  ...
  waveBar: { width: 3, borderRadius: 2, backgroundColor: '#4CAF50', marginHorizontal: 1 },
  ...
  menuRowText: { color: '#0B2211', fontSize: 13, fontWeight: '500', marginLeft: 10 },
  settingsOverlay: {
    flex: 1,
  ...
  settingsTitle: { color: '#0B2211', fontSize: 16, fontWeight: 'bold' },
  settingsDone: { color: '#4CAF50', fontSize: 14, fontWeight: 'bold' },
  settingsLabel: {
    color: '#0B2211',
    fontSize: 13,
    fontWeight: '600',
  ...
  themeChipActive: { borderColor: '#4CAF50' },
